"""Regression checks for the vista-svc-gateway-pipe casebook."""
...
from casebook.harness import assert_expected, vista_svc_gateway_pipe_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(vista_svc_gateway_pipe_summary(), assert_expected())
